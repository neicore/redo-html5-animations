...
function changeLetter(currentLetter, replacingLetter, posX_1, posY_1, posX_2, posY_2) {
...
changeLetter(my_m_alt, my_m, 80, 0, 0, 0);
changeLetter(spot_p_alt, spot_p, 75, 0, 0, 0);
changeLetter(spot_o_alt, spot_o, 80, 0, 0, 0);
changeLetter(connection_c_0_alt, connection_c_0, 0, 70, 0, 0);
changeLetter(connection_o_0_alt, connection_o_0, 0, -53, 0, 0);
changeLetter(connection_n_0_alt, connection_n_0, -40, 0, 0, 0);
changeLetter(connection_n_1_alt, connection_n_1, -40, 0, 0, 0);
changeLetter(connection_e_alt, connection_e, 40, 0, 0, 0);
changeLetter(connection_c_1_alt, connection_c_1, 0, -55, 0, 0);
changeLetter(connection_t_alt, connection_t, -30, 0, 0, 0);
changeLetter(connection_i_alt, connection_i, 25, 0, 0, 0);
changeLetter(connection_o_1_alt, connection_o_1, 0, -53, 0, 0);
changeLetter(connection_n_2_alt, connection_n_2, 0, 52, 0, 0);
...
let timeOut = 3000;
let timeoutIncrement = 3000;

function callThem() {
    setTimeout(() => {
        changeLetter(my_m_alt, my_m, 0, 0, -80, 0,);
        changeLetter(my_y_alt, my_y, 0, 0, 50, 0,);
        changeLetter(friend_alt, friend, 0, 0, 0, 80,);
    }, timeOut);

    setTimeout(() => {
        changeLetter(spot_s_alt, spot_s, 0, 0, 75, 0);
        changeLetter(spot_p, spot_p_alt, -75, 0, 0, 0);
        changeLetter(spot_o, spot_o_alt, -80, 0, 0, 0);
        changeLetter(spot_t_alt, spot_t, 0, 0, 0, 100);
        changeLetter(your_alt, your, 0, 0, 0, 80);
    }, timeOut + 2000);
    ...
    setTimeout(() => {
        changeLetter(my_m_alt, my_m, 80, 0, 0, 0);
        changeLetter(my_y_alt, my_y, 80, 0, 0, 0);

        changeLetter(spot_s_alt, spot_s, 80, 0, 0, 0);
        changeLetter(spot_p_alt, spot_p, 80, 0, 0, 0);
        changeLetter(spot_o_alt, spot_o, 80, 0, 0, 0);
        changeLetter(spot_t_alt, spot_t, 80, 0, 0, 0);
    }, timeOut + 3500);

    setTimeout(() => {
        changeLetter(your_alt, your, -250, 0, 0, 0);
        changeLetter(friend_alt, friend, -350, 0, 0, 0);
    }, timeOut + 4500);

    setTimeout(() => {
        changeLetter(connection_c_0, connection_c_0_alt, 0, 80, 0, 0);
        changeLetter(connection_o_0, connection_o_0_alt, 0, 80, 0, 0);
        changeLetter(connection_n_0, connection_n_0_alt, 0, 80, 0, 0);
        changeLetter(connection_n_1, connection_n_1_alt, 0, 80, 0, 0);
        changeLetter(connection_e, connection_e_alt, 0, 80, 0, 0);
        changeLetter(connection_c_1, connection_c_1_alt, 0, 80, 0, 0);
        changeLetter(connection_t, connection_t_alt, 0, 80, 0, 0);
        changeLetter(connection_i, connection_i_alt, 0, 80, 0, 0);
        changeLetter(connection_o_1, connection_o_1_alt, 0, 80, 0, 0);
        changeLetter(connection_n_2, connection_n_2_alt, 0, 80, 0, 0);
    }, timeOut + 6000);
    ...
    setTimeout(() => {
        changeLetter(connection_c_0, connection_c_0_alt, 0, 0, -80, 0);
        changeLetter(connection_o_0, connection_o_0_alt, 0, 0, -80, 0);
        changeLetter(connection_n_0, connection_n_0_alt, 0, 0, -80, 0);
        changeLetter(connection_n_1, connection_n_1_alt, 0, 0, -80, 0);
        changeLetter(connection_e, connection_e_alt, 0, 0, -80, 0);
        changeLetter(connection_c_1, connection_c_1_alt, 0, 0, -80, 0);
        changeLetter(connection_t, connection_t_alt, 0, 0, -80, 0);
        changeLetter(connection_i, connection_i_alt, 0, 0, -80, 0);
        changeLetter(connection_o_1, connection_o_1_alt, 0, 0, -80, 0);
        changeLetter(connection_n_2, connection_n_2_alt, 0, 0, -80, 0);
    }, timeOut + 8000);
}
